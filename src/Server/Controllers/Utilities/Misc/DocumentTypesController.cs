...
using CustomerManager.Application.Features.DocumentTypes.Commands.Delete;
using CustomerManager.Application.Features.DocumentTypes.Queries.Export;
...
namespace CustomerManager.Server.Controllers.Utilities.Misc
{
