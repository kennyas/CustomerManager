...
using CustomerManager.Application.Features.ExtendedAttributes.Commands.AddEdit;
using CustomerManager.Application.Features.ExtendedAttributes.Commands.Delete;
using CustomerManager.Application.Features.ExtendedAttributes.Queries.Export;
using CustomerManager.Application.Features.ExtendedAttributes.Queries.GetAll;
using CustomerManager.Application.Features.ExtendedAttributes.Queries.GetAllByEntityId;
using CustomerManager.Application.Features.ExtendedAttributes.Queries.GetById;
using CustomerManager.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace CustomerManager.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
