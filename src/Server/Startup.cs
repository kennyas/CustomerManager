...
using CustomerManager.Server.Extensions;
using CustomerManager.Server.Middlewares;
using Hangfire;
...
using System.IO;
using CustomerManager.Server.Filters;
using CustomerManager.Server.Managers.Preferences;
using Microsoft.Extensions.Localization;

namespace CustomerManager.Server
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IStringLocalizer<Startup> localizer)
        {
            ...
            {
                DashboardTitle = localizer["CustomerMgt Jobs"],
