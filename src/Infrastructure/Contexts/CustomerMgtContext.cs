...
namespace CustomerManager.Infrastructure.Contexts
{
    public class CustomerMgtContext : AuditableContext
    {
        private readonly ICurrentUserService _currentUserService;
        private readonly IDateTimeService _dateTimeService;

        public CustomerMgtContext(DbContextOptions<CustomerMgtContext> options, ICurrentUserService currentUserService, IDateTimeService dateTimeService)
            : base(options)
        {
