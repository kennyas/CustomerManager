...
using CustomerManager.Client.Extensions;
using CustomerManager.Client.Infrastructure.Managers.ExtendedAttribute;
using CustomerManager.Domain.Contracts;
using CustomerManager.Domain.Enums;
using CustomerManager.Shared.Constants.Application;
...
namespace CustomerManager.Client.Shared.Components
{
