...
using CustomerManager.Client.Infrastructure.Authentication;
using CustomerManager.Client.Infrastructure.Managers;
using CustomerManager.Client.Infrastructure.Managers.Preferences;
...
using CustomerManager.Domain.Entities.ExtendedAttributes;
using CustomerManager.Domain.Entities.Misc;
using Toolbelt.Blazor.Extensions.DependencyInjection;

namespace CustomerManager.Client.Extensions
{
    public static class WebAssemblyHostBuilderExtensions
    {
        ...
        public static WebAssemblyHostBuilder AddClientServices(this WebAssemblyHostBuilder builder)
        {
            builder
                ...
                .AddScoped<CustomerMgtStateProvider>()
                .AddScoped<AuthenticationStateProvider, CustomerMgtStateProvider>()
                .AddManagers()
