...
namespace CustomerManager.Client.Infrastructure.Authentication
{
    public class CustomerMgtStateProvider : AuthenticationStateProvider
    {
        private readonly HttpClient _httpClient;
        private readonly ILocalStorageService _localStorage;

        public CustomerMgtStateProvider(
