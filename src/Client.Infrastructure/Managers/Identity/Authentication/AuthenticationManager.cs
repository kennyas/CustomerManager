...
using CustomerManager.Client.Infrastructure.Routes;
using CustomerManager.Shared.Constants.Storage;
using Microsoft.Extensions.Localization;

namespace CustomerManager.Client.Infrastructure.Managers.Identity.Authentication
{
    public class AuthenticationManager : IAuthenticationManager
    {
        ...
        public async Task<IResult> Login(TokenRequest model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                ((CustomerMgtStateProvider)this._authenticationStateProvider).MarkUserAsAuthenticated(model.Email);
        ...
        public async Task<IResult> Logout()
        {
            ...
            ((CustomerMgtStateProvider)_authenticationStateProvider).MarkUserAsLoggedOut();
